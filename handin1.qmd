...
## Suggested format for qmd files

To assist your peers in marking your work, we *strongly* suggest that you make this *easy* for them.

The fastest way to to do this is the following:

- Use headings liberally (`#`, `##`, `###`, etc).
- Echo key code chunks

The headings ensure that it is easy to understand what is where, and the echoing ensures that they do not have to dig into your GitHub account to see the code.

For example, for prac 1 question 1, the following would be a good format:
...
If you want to be extra clear, then you can also add the question:
