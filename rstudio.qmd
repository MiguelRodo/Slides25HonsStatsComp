...
1. **Install the Latest Version of R**  
   ...
   **_IMPORTANT:_** Ensure you update to the latest version before starting this course—even if R is already installed—as older versions may cause unexpected issues when using newer `R` packages.
